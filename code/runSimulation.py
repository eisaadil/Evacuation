'''
Main run simulation file.

Workflow:
    Set variables and run file. 
    Set caption for the plot.
    To escape simulation and display graph press ESC during the sim.
    To exit simulation and no graph close the sim window.
'''
